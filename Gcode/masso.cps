...
function onOpen() {
  ...
  writeComment('Fusion360 - MASSO post') // INM added to identify generated code
...
function onClose() {
  ...
  if (getSetting("retract.homeXY.onProgramEnd", false)) {
    ...
    writeComment('INM - park instead of home')
    writeBlock(gFormat.format(30)); // INM - park on completion
  }
